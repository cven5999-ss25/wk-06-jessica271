...
2.  Describe the variables
    ...
    **Variables** are the columns in the city_data for example, city, country and income_id. There are 31 variables in the data.

3.  Describe the observations

    **Observations** are the data being measured in the city_data object. For example, income_id, population and waste_treatment_compost_percent.
...
```{r}
distance_complete <- distance |>
  na.omit(transportation_distance_total_km_year)
```
